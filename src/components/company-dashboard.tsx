...
export default function CompanyDashboard() {
  ...
  async function handleSettleCycle() {
    try {
      ...
      setMessage("Quincena finalizada correctamente.");
    } catch (err) {
      const msg =
        err instanceof Error
          ? err.message
          : "No se pudo finalizar la quincena.";
      setError(msg);
    }
  }
      ...
      <div className="mx-auto max-w-7xl">
          ...
          <div className="relative z-10 flex flex-col gap-6 xl:flex-row xl:items-end xl:justify-between">
            <div className="max-w-3xl">
              ...
              <p className="mt-4 max-w-2xl text-base text-slate-300 md:text-lg">
                Control de solicitudes, elegibilidad y quincenas.
              </p>
            </div>
        ...
        <section className="mt-8 grid gap-5 md:grid-cols-2 xl:grid-cols-5">
          <div className="rounded-3xl border border-slate-800 bg-slate-900 p-6">
            <p className="text-sm text-slate-400">Quincena actual</p>
              ...
              >
                <div className="flex flex-col gap-5">
                  ...
                  <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
                    ...
                    <div className="rounded-2xl border border-slate-800 bg-slate-900 p-4">
                      <p className="text-sm text-slate-400">Últimas solicitudes</p>
                      <p className="mt-2 text-xl font-semibold">
        ...
        <section className="mt-8 rounded-3xl border border-slate-800 bg-slate-900 p-6">
          ...
          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            ...
            <div className="rounded-2xl border border-slate-800 bg-slate-950 p-5">
              <p className="text-sm text-slate-400">Solicitudes por quincena</p>
              <p className="mt-2 text-xl font-semibold">
